...
namespace DAL
{
    ...
    /// 部门表数据库操作对象
    /// </summary>
    public class DepartmentInfoDal: DelBaseDal<DepartmentInfo>,IDepartmentInfoDal
    {
        // 注入数据库上下文对象
        private readonly DepositoryContext _depositoryContext;
        public DepartmentInfoDal(DepositoryContext depositoryContext):base(depositoryContext)
        {
